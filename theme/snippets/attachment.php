...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<p><a href="<?php echo get_permalink( $post->post_parent ); ?>" title="<?php esc_attr( printf( __( 'Return to %s'), get_the_title( $post->post_parent ) ) ); ?>" rel="gallery"><?php
				...
				?></a></p>
					...
					<h2><?php the_title(); ?></h2>
						...
						?>
						<?php edit_post_link( __( 'Edit'), '<span>|</span> <span>', '</span>' ); ?>
...
<?php the_content( __( 'Continue reading <span>&rarr;</span>') ); ?>
